package com.qsoft.InternalAndExternal;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.saveInternalStorage:
                ...
                myInputText.setText("");
                responseText
                        .setText("MyFile.txt saved to Internal Storage...");
                break;
            ...
            case R.id.getInternalStorage:
                ...
                responseText
                        .setText("MyFile.txt data retrieved from Internal Storage...");
                break;
            ...
            case R.id.saveExternalStorage:
                ...
                myInputText.setText("");
                responseText
                        .setText("MyFile.txt saved to External Storage...");
                break;
